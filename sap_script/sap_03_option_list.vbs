...
' Arg(6) : 파일 인코딩 = "0000"
' Arg(7) : Production Order no - "110001175810"
Dim Arg
...
session.findById("wnd[0]/usr/ctxtS_AUFNR-LOW").text = Arg(7)
session.findById("wnd[0]/usr/ctxtS_AUFNR-LOW").setFocus
session.findById("wnd[0]/usr/ctxtS_AUFNR-LOW").caretPosition = 12
